        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPermissions_IdentityUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "IdentityUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "b2c8a365-f9b8-492d-9d16-29a8f3339712", "Full system access", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "IdentityUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FullName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { 1, 0, "f02f17ab-231b-4372-8db1-e2827bc1c0c7", "admin@quickpos.com", true, "System Administrator", false, null, "ADMIN@QUICKPOS.COM", "ADMIN", "AQAAAAIAAYagAAAAEK1cV2qXZ9vC+9o5t3N1p7d5F3qX8w9r2z4k1L6m3n8p9q0r2s5t7u4v6w8x1y3z", null, false, "ADMIN-SECURITY-STAMP-2025", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "PermissionKey", "UserId" },
                values: new object[,]
                {
                    { 1, "Nav.Selling", 1 },
                    { 2, "Nav.Products", 1 },
